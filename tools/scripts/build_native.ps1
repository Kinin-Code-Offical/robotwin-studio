...
$Sources = "NativeEngine/src/NativeEngine_Core.cpp", "NativeEngine/src/Core/CircuitContext.cpp", "NativeEngine/src/Core/NodalSolver.cpp", "NativeEngine/src/Core/BvmFormat.cpp", "NativeEngine/src/MCU/ATmega328P_ISA.c"
