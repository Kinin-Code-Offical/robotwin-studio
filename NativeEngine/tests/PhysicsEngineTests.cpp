...
namespace NativeEngine::Physics::Tests
{
    ...
    bool Test_SphereSphereCollision()
    {
        ...
        sphere1.radius = 0.5f;
        sphere1.shape = RigidBody::ShapeType::Sphere;

        RigidBody sphere2{};
        sphere2.mass = 1.0f;
        sphere2.position = {0.8f, 0.0f, 0.0f}; // Overlapping
        sphere2.radius = 0.5f;
        sphere2.shape = RigidBody::ShapeType::Sphere;
    ...
    bool Test_Raycast()
    {
        ...
        body.radius = 1.0f;
        body.shape = RigidBody::ShapeType::Sphere;
    ...
    bool Test_Performance_ManyBodies()
    {
        ...
        for (int i = 0; i < bodyCount; ++i)
        {
            RigidBody body{};
            body.mass = 1.0f;
            body.position = {(i % 10) * 2.0f, (i / 10) * 2.0f, 0.0f};
            body.radius = 0.5f;
