...
| Unity                  | `UnityApp/ProjectSettings/ProjectVersion.txt` | `6000.3.2f1` | **Pinned in ProjectVersion.txt** |
...
| **Unity Editor**   | `6000.3.2f1`   | Pinned in `ProjectVersion.txt` |
| **Actions**        | `v4`           | Latest stable major versions   |

## Audit Findings

1. **UnityApp**: Unity version is pinned via `UnityApp/ProjectSettings/ProjectVersion.txt`.
