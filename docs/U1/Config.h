...
namespace ServoLimits
{
    ...
    constexpr uint16_t SERVO_COOLDOWN_MS = 1000;    // Detach sonrası bekleme
    constexpr uint8_t SERVO_STALL_CURRENT_MA = 500; // Stall akımı (tehlike)
}
...
namespace Safety
{
    constexpr uint32_t STATE_STUCK_TIMEOUT_MS = 10000; // 10s deadlock timeout
    constexpr uint8_t EMERGENCY_STOP_THRESHOLD = 5;    // Max allowed consecutive errors
}
