...
3. Also record the chosen tier in the session report:
   - GitHub Issue: **“Status Log – Run Reports”** comment, and
   - `docs/antigravity/LAST_RUN.md` (Run Summary).
4. If you make two consecutive failed attempts to solve a problem (e.g., build/CI failing, unclear architecture, repeated bug), escalate **one tier** for the next attempt.
...
- Creating issues, labels, milestones, PR templates, docs formatting
...
- Writing unit tests and basic smoke tests
